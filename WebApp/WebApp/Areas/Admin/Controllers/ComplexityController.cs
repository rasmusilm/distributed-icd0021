...
namespace WebApp.Areas_Admin_Controllers
{
    public class ComplexityController : Controller
    {
        ...
        // GET: Complexity/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Complexity/Create
